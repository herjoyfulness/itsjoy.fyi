        ...
        <ModalContainer left='0' width={{ default: '100%', m: '48em' }} padding={{ default: '0 0 2em 0', s: '5em 7.5em' }}>
            <Flex margin='auto' flexDirection='column' width={{ default: '18em', s: '100%' }}>
                ...
                <Flex justifyContent='space-between' alignItems='center'>
                    <H2 fontFamily='Lato' fontSize='1.2em' color='#000'>Resume</H2>
                ...
                <Flex justifyContent='space-between' alignItems='center' flexDirection='column' mt='3em'>
                    <H3>You can stalk me on</H3>
                    <Flex justifyContent='space-between'>
                        <A fontFamily='Lato' color='#000' margin='.5em' mt='0' href='https://github.com/herjoyfulness'>Github</A>
                        <A fontFamily='Lato' color='#000' margin='.5em' mt='0' href='https://www.linkedin.com/in/herjoyfulness/'>LinkedIn</A>
                        <A fontFamily='Lato' color='#000' margin='.5em' mt='0' href='http://instagram.com/herjoyfulness'>Instagram</A>
                        <A fontFamily='Lato' color='#000' margin='.5em' mt='0' href='https://open.spotify.com/user/joyisabellahelena'>Spotify</A>
                    </Flex>
                </Flex>
            </Flex>
        </ModalContainer>
